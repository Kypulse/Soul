...
// Thank you to them for a bit of this code:
// https://github.com/MeteorDevelopment/meteor-client/blob/master/src/main/java/meteordevelopment/meteorclient/systems/modules/render/TunnelESP.java
//and
//https://github.com/etianl/Trouser-Streak/blob/main/src/main/java/pwn/noobs/trouserstreak/modules/HoleAndTunnelAndStairsESP.java
...
public class HoleTunnelStairsESP extends Module {
    ...
    public HoleTunnelStairsESP() {
        super(SoulAddon.CATEGORY, "Hole/Tunnel/StairsESP", "Finds and highlights holes and tunnels and stairs. Credit to etianl for src i skided from!");
    }
